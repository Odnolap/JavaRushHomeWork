...
public class Solution {
    ...
    {
        private static AtomicInteger factoriesCount = new AtomicInteger(1);
        private int factoryNumber = factoriesCount.getAndIncrement();
        private AtomicInteger threadNumber = new AtomicInteger(1);

        @Override
        public Thread newThread(Runnable r)
        {
            return new Thread(r, Thread.currentThread().getThreadGroup().getName() + "-pool-" + factoryNumber + "-thread-" + threadNumber.getAndIncrement());
        }
