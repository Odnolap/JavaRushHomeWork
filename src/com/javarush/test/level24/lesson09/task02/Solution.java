    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>()
        {
            public int compare(Stock stock1, Stock stock2)
            {
                ...
                if (stock1 == null && stock2 == null) return 0;
                else if (stock1 == null) return -1;
                else if (stock2 == null) return 1;
                else if (stock1 == stock2) return 0;
                else if (!((String) stock1.get("name")).equals((String) stock2.get("name")))
                    return ((String) stock1.get("name")).compareTo((String) stock2.get("name"));
                else if (!df.format((Date) stock1.get("date")).equals(df.format((Date) stock2.get("date"))))
                    return df.format((Date) stock1.get("date")).compareTo(df.format((Date) stock2.get("date"))) * -1;
                else
                {
                    double ch1;
                    double ch2;
