...
public class Solution implements Action {
    ...
    private Action solutionAction = new Action() {
        ...
        public void someAction() {
            ...
            class SecondClassChild extends SecondClass
            {
                @Override
                public void someAction()
                {
                    super.someAction();
                    System.out.println(SPECIFIC_ACTION_FOR_ANONYMOUS_SECOND_CLASS_PARAM.replaceAll("\n", "") + param);
                }
            }

            class FirstClassChild extends FirstClass
            {
                @Override
                public Action getDependantAction()
                {
                    return new SecondClassChild();
                }
            }
            ...
            if (param > 0)
            {
                ...
                FirstClassChild firstClassChild = new FirstClassChild();
                firstClassChild.someAction();
                firstClassChild.getDependantAction().someAction();
            }
            else
            {
                SecondClassChild secondClassChild = new SecondClassChild();
                secondClassChild.someAction();
            }
