...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        om.writeValue(sw, one);
        String s = sw.toString().replaceFirst(one.getClass().getSimpleName().toLowerCase(), resultClassObject.getSimpleName().toLowerCase());

        StringReader sr = new StringReader(s);
        return new ObjectMapper().readValue(sr, resultClassObject);
    }
